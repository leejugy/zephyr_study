...
class SHACLObject:
    ...
    @classmethod
    def _make_object(cls: Type[T_SHACLObject], typ: str) -> SHACLObject: ...
    @classmethod
    def decode(
...
class SHACLObjectSet:
    ...
    def encode(
        self, encoder: "Encoder", state: "EncodeState", force_at_graph: bool = False
    ) -> None: ...
    def decode(
        self,
        decoder: "Decoder",
...
class ai_EnergyConsumption(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/AI/EnergyConsumption"
    COMPACT_TYPE: ClassVar[Optional[str]] = "ai_EnergyConsumption"
    NODE_KIND: ClassVar[NodeKind]
    ...
    @property
    def ai_finetuningEnergyConsumption(self) -> ListProxy[Union[str, 'ai_EnergyConsumptionDescription']]: ...
    @ai_finetuningEnergyConsumption.setter
    def ai_finetuningEnergyConsumption(self, value: Iterable[Union[str, 'ai_EnergyConsumptionDescription']]) -> None: ...
    @property
    def ai_inferenceEnergyConsumption(self) -> ListProxy[Union[str, 'ai_EnergyConsumptionDescription']]: ...
    @ai_inferenceEnergyConsumption.setter
    def ai_inferenceEnergyConsumption(self, value: Iterable[Union[str, 'ai_EnergyConsumptionDescription']]) -> None: ...
    @property
    def ai_trainingEnergyConsumption(self) -> ListProxy[Union[str, 'ai_EnergyConsumptionDescription']]: ...
    @ai_trainingEnergyConsumption.setter
    def ai_trainingEnergyConsumption(self, value: Iterable[Union[str, 'ai_EnergyConsumptionDescription']]) -> None: ...
...
class ai_EnergyConsumptionDescription(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/AI/EnergyConsumptionDescription"
    COMPACT_TYPE: ClassVar[Optional[str]] = "ai_EnergyConsumptionDescription"
    NODE_KIND: ClassVar[NodeKind]
...
class ai_EnergyUnitType(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/AI/EnergyUnitType"
    COMPACT_TYPE: ClassVar[Optional[str]] = "ai_EnergyUnitType"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
    # Kilowatt-hour.
    kilowattHour: str
...
class ai_SafetyRiskAssessmentType(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/AI/SafetyRiskAssessmentType"
    COMPACT_TYPE: ClassVar[Optional[str]] = "ai_SafetyRiskAssessmentType"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class AnnotationType(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/AnnotationType"
    COMPACT_TYPE: ClassVar[Optional[str]] = "AnnotationType"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class CreationInfo(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/CreationInfo"
    COMPACT_TYPE: ClassVar[Optional[str]] = "CreationInfo"
    NODE_KIND: ClassVar[NodeKind]
    ...
    @property
    def createdBy(self) -> ListProxy[Union[str, 'Agent']]: ...
    @createdBy.setter
    def createdBy(self, value: Iterable[Union[str, 'Agent']]) -> None: ...
    @property
    def createdUsing(self) -> ListProxy[Union[str, 'Tool']]: ...
    @createdUsing.setter
    def createdUsing(self, value: Iterable[Union[str, 'Tool']]) -> None: ...
...
class DictionaryEntry(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/DictionaryEntry"
    COMPACT_TYPE: ClassVar[Optional[str]] = "DictionaryEntry"
    NODE_KIND: ClassVar[NodeKind]
...
class Element(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/Element"
    COMPACT_TYPE: ClassVar[Optional[str]] = "Element"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
    IS_ABSTRACT: ClassVar[bool]
    ...
    @property
    def extension(self) -> ListProxy[Union[str, 'extension_Extension']]: ...
    @extension.setter
    def extension(self, value: Iterable[Union[str, 'extension_Extension']]) -> None: ...
    @property
    def externalIdentifier(self) -> ListProxy[Union[str, 'ExternalIdentifier']]: ...
    @externalIdentifier.setter
    def externalIdentifier(self, value: Iterable[Union[str, 'ExternalIdentifier']]) -> None: ...
    @property
    def externalRef(self) -> ListProxy[Union[str, 'ExternalRef']]: ...
    @externalRef.setter
    def externalRef(self, value: Iterable[Union[str, 'ExternalRef']]) -> None: ...
    name: Optional[str]
    summary: Optional[str]
    @property
    def verifiedUsing(self) -> ListProxy[Union[str, 'IntegrityMethod']]: ...
    @verifiedUsing.setter
    def verifiedUsing(self, value: Iterable[Union[str, 'IntegrityMethod']]) -> None: ...
...
class ElementCollection(Element):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/ElementCollection"
    COMPACT_TYPE: ClassVar[Optional[str]] = "ElementCollection"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
    IS_ABSTRACT: ClassVar[bool]
    ...
    spdxId: Optional[str]
    @property
    def element(self) -> ListProxy[Union[str, 'Element']]: ...
    @element.setter
    def element(self, value: Iterable[Union[str, 'Element']]) -> None: ...
    @property
    def profileConformance(self) -> ListProxy[str]: ...
    @profileConformance.setter
    def profileConformance(self, value: Iterable[str]) -> None: ...
    @property
    def rootElement(self) -> ListProxy[Union[str, 'Element']]: ...
    @rootElement.setter
    def rootElement(self, value: Iterable[Union[str, 'Element']]) -> None: ...
...
class ExternalIdentifier(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/ExternalIdentifier"
    COMPACT_TYPE: ClassVar[Optional[str]] = "ExternalIdentifier"
    NODE_KIND: ClassVar[NodeKind]
    ...
    @property
    def identifierLocator(self) -> ListProxy[str]: ...
    @identifierLocator.setter
    def identifierLocator(self, value: Iterable[str]) -> None: ...
...
class ExternalIdentifierType(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/ExternalIdentifierType"
    COMPACT_TYPE: ClassVar[Optional[str]] = "ExternalIdentifierType"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class ExternalMap(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/ExternalMap"
    COMPACT_TYPE: ClassVar[Optional[str]] = "ExternalMap"
    NODE_KIND: ClassVar[NodeKind]
...
class ExternalRef(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/ExternalRef"
    COMPACT_TYPE: ClassVar[Optional[str]] = "ExternalRef"
    NODE_KIND: ClassVar[NodeKind]
    ...
    @property
    def locator(self) -> ListProxy[str]: ...
    @locator.setter
    def locator(self, value: Iterable[str]) -> None: ...
...
class ExternalRefType(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/ExternalRefType"
    COMPACT_TYPE: ClassVar[Optional[str]] = "ExternalRefType"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class HashAlgorithm(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/HashAlgorithm"
    COMPACT_TYPE: ClassVar[Optional[str]] = "HashAlgorithm"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class IndividualElement(Element):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/IndividualElement"
    COMPACT_TYPE: ClassVar[Optional[str]] = "IndividualElement"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class IntegrityMethod(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/IntegrityMethod"
    COMPACT_TYPE: ClassVar[Optional[str]] = "IntegrityMethod"
    NODE_KIND: ClassVar[NodeKind]
    IS_ABSTRACT: ClassVar[bool]
...
class LifecycleScopeType(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/LifecycleScopeType"
    COMPACT_TYPE: ClassVar[Optional[str]] = "LifecycleScopeType"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class NamespaceMap(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/NamespaceMap"
    COMPACT_TYPE: ClassVar[Optional[str]] = "NamespaceMap"
    NODE_KIND: ClassVar[NodeKind]
...
class PackageVerificationCode(IntegrityMethod):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/PackageVerificationCode"
    COMPACT_TYPE: ClassVar[Optional[str]] = "PackageVerificationCode"
    NODE_KIND: ClassVar[NodeKind]
    ...
    @property
    def packageVerificationCodeExcludedFile(self) -> ListProxy[str]: ...
    @packageVerificationCodeExcludedFile.setter
    def packageVerificationCodeExcludedFile(self, value: Iterable[str]) -> None: ...
...
class PositiveIntegerRange(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/PositiveIntegerRange"
    COMPACT_TYPE: ClassVar[Optional[str]] = "PositiveIntegerRange"
    NODE_KIND: ClassVar[NodeKind]
...
class PresenceType(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/PresenceType"
    COMPACT_TYPE: ClassVar[Optional[str]] = "PresenceType"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class ProfileIdentifierType(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/ProfileIdentifierType"
    COMPACT_TYPE: ClassVar[Optional[str]] = "ProfileIdentifierType"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class Relationship(Element):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/Relationship"
    COMPACT_TYPE: ClassVar[Optional[str]] = "Relationship"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
    ...
    @property
    def to(self) -> ListProxy[Union[str, 'Element']]: ...
    @to.setter
    def to(self, value: Iterable[Union[str, 'Element']]) -> None: ...
...
class RelationshipCompleteness(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/RelationshipCompleteness"
    COMPACT_TYPE: ClassVar[Optional[str]] = "RelationshipCompleteness"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class RelationshipType(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/RelationshipType"
    COMPACT_TYPE: ClassVar[Optional[str]] = "RelationshipType"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class SpdxDocument(ElementCollection):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/SpdxDocument"
    COMPACT_TYPE: ClassVar[Optional[str]] = "SpdxDocument"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
    ...
    @property
    def import_(self) -> ListProxy[Union[str, 'ExternalMap']]: ...
    @import_.setter
    def import_(self, value: Iterable[Union[str, 'ExternalMap']]) -> None: ...
    @property
    def namespaceMap(self) -> ListProxy[Union[str, 'NamespaceMap']]: ...
    @namespaceMap.setter
    def namespaceMap(self, value: Iterable[Union[str, 'NamespaceMap']]) -> None: ...
...
class SupportType(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/SupportType"
    COMPACT_TYPE: ClassVar[Optional[str]] = "SupportType"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class Tool(Element):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/Tool"
    COMPACT_TYPE: ClassVar[Optional[str]] = "Tool"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class dataset_ConfidentialityLevelType(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Dataset/ConfidentialityLevelType"
    COMPACT_TYPE: ClassVar[Optional[str]] = "dataset_ConfidentialityLevelType"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class dataset_DatasetAvailabilityType(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Dataset/DatasetAvailabilityType"
    COMPACT_TYPE: ClassVar[Optional[str]] = "dataset_DatasetAvailabilityType"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class dataset_DatasetType(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Dataset/DatasetType"
    COMPACT_TYPE: ClassVar[Optional[str]] = "dataset_DatasetType"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class expandedlicensing_LicenseAddition(Element):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/ExpandedLicensing/LicenseAddition"
    COMPACT_TYPE: ClassVar[Optional[str]] = "expandedlicensing_LicenseAddition"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
    IS_ABSTRACT: ClassVar[bool]
    ...
    @property
    def expandedlicensing_seeAlso(self) -> ListProxy[str]: ...
    @expandedlicensing_seeAlso.setter
    def expandedlicensing_seeAlso(self, value: Iterable[str]) -> None: ...
...
class expandedlicensing_ListedLicenseException(expandedlicensing_LicenseAddition):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/ExpandedLicensing/ListedLicenseException"
    COMPACT_TYPE: ClassVar[Optional[str]] = "expandedlicensing_ListedLicenseException"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class extension_CdxPropertyEntry(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Extension/CdxPropertyEntry"
    COMPACT_TYPE: ClassVar[Optional[str]] = "extension_CdxPropertyEntry"
    NODE_KIND: ClassVar[NodeKind]
...
class extension_Extension(SHACLExtensibleObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Extension/Extension"
    COMPACT_TYPE: ClassVar[Optional[str]] = "extension_Extension"
    NODE_KIND: ClassVar[NodeKind]
    IS_ABSTRACT: ClassVar[bool]
...
class security_CvssSeverityType(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Security/CvssSeverityType"
    COMPACT_TYPE: ClassVar[Optional[str]] = "security_CvssSeverityType"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class security_ExploitCatalogType(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Security/ExploitCatalogType"
    COMPACT_TYPE: ClassVar[Optional[str]] = "security_ExploitCatalogType"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class security_SsvcDecisionType(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Security/SsvcDecisionType"
    COMPACT_TYPE: ClassVar[Optional[str]] = "security_SsvcDecisionType"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class security_VexJustificationType(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Security/VexJustificationType"
    COMPACT_TYPE: ClassVar[Optional[str]] = "security_VexJustificationType"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class security_VulnAssessmentRelationship(Relationship):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Security/VulnAssessmentRelationship"
    COMPACT_TYPE: ClassVar[Optional[str]] = "security_VulnAssessmentRelationship"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
    IS_ABSTRACT: ClassVar[bool]
...
class simplelicensing_AnyLicenseInfo(Element):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/SimpleLicensing/AnyLicenseInfo"
    COMPACT_TYPE: ClassVar[Optional[str]] = "simplelicensing_AnyLicenseInfo"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
    IS_ABSTRACT: ClassVar[bool]
...
class simplelicensing_LicenseExpression(simplelicensing_AnyLicenseInfo):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/SimpleLicensing/LicenseExpression"
    COMPACT_TYPE: ClassVar[Optional[str]] = "simplelicensing_LicenseExpression"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
    ...
    spdxId: Optional[str]
    @property
    def simplelicensing_customIdToUri(self) -> ListProxy[Union[str, 'DictionaryEntry']]: ...
    @simplelicensing_customIdToUri.setter
    def simplelicensing_customIdToUri(self, value: Iterable[Union[str, 'DictionaryEntry']]) -> None: ...
...
class simplelicensing_SimpleLicensingText(Element):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/SimpleLicensing/SimpleLicensingText"
    COMPACT_TYPE: ClassVar[Optional[str]] = "simplelicensing_SimpleLicensingText"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class software_ContentIdentifier(IntegrityMethod):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Software/ContentIdentifier"
    COMPACT_TYPE: ClassVar[Optional[str]] = "software_ContentIdentifier"
    NODE_KIND: ClassVar[NodeKind]
...
class software_ContentIdentifierType(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Software/ContentIdentifierType"
    COMPACT_TYPE: ClassVar[Optional[str]] = "software_ContentIdentifierType"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
    # [Gitoid](https://www.iana.org/assignments/uri-schemes/prov/gitoid), stands for [Git Object ID](https://git-scm.com/book/en/v2/Git-Internals-Git-Objects). A gitoid of type blob is a unique hash of a binary artifact. A gitoid may represent either an [Artifact Identifier](https://github.com/omnibor/spec/blob/eb1ee5c961c16215eb8709b2975d193a2007a35d/spec/SPEC.md#artifact-identifier-types) for the software artifact or an [Input Manifest Identifier](https://github.com/omnibor/spec/blob/eb1ee5c961c16215eb8709b2975d193a2007a35d/spec/SPEC.md#input-manifest-identifier) for the software artifact's associated [Artifact Input Manifest](https://github.com/omnibor/spec/blob/eb1ee5c961c16215eb8709b2975d193a2007a35d/spec/SPEC.md#artifact-input-manifest); this ambiguity exists because the Artifact Input Manifest is itself an artifact, and the gitoid of that artifact is its valid identifier. Gitoids calculated on software artifacts (Snippet, File, or Package Elements) should be recorded in the SPDX 3.0 SoftwareArtifact's contentIdentifier property. Gitoids calculated on the Artifact Input Manifest (Input Manifest Identifier) should be recorded in the SPDX 3.0 Element's externalIdentifier property. See [OmniBOR Specification](https://github.com/omnibor/spec/), a minimalistic specification for describing software [Artifact Dependency Graphs](https://github.com/omnibor/spec/blob/eb1ee5c961c16215eb8709b2975d193a2007a35d/spec/SPEC.md#artifact-dependency-graph-adg).
    gitoid: str
...
class software_FileKindType(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Software/FileKindType"
    COMPACT_TYPE: ClassVar[Optional[str]] = "software_FileKindType"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class software_SbomType(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Software/SbomType"
    COMPACT_TYPE: ClassVar[Optional[str]] = "software_SbomType"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class software_SoftwarePurpose(SHACLObject):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Software/SoftwarePurpose"
    COMPACT_TYPE: ClassVar[Optional[str]] = "software_SoftwarePurpose"
    NODE_KIND: ClassVar[NodeKind]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class build_Build(Element):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Build/Build"
    COMPACT_TYPE: ClassVar[Optional[str]] = "build_Build"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
    ...
    @property
    def build_configSourceDigest(self) -> ListProxy[Union[str, 'Hash']]: ...
    @build_configSourceDigest.setter
    def build_configSourceDigest(self, value: Iterable[Union[str, 'Hash']]) -> None: ...
    @property
    def build_configSourceEntrypoint(self) -> ListProxy[str]: ...
    @build_configSourceEntrypoint.setter
    def build_configSourceEntrypoint(self, value: Iterable[str]) -> None: ...
    @property
    def build_configSourceUri(self) -> ListProxy[str]: ...
    @build_configSourceUri.setter
    def build_configSourceUri(self, value: Iterable[str]) -> None: ...
    @property
    def build_environment(self) -> ListProxy[Union[str, 'DictionaryEntry']]: ...
    @build_environment.setter
    def build_environment(self, value: Iterable[Union[str, 'DictionaryEntry']]) -> None: ...
    @property
    def build_parameter(self) -> ListProxy[Union[str, 'DictionaryEntry']]: ...
    @build_parameter.setter
    def build_parameter(self, value: Iterable[Union[str, 'DictionaryEntry']]) -> None: ...
...
class Agent(Element):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/Agent"
    COMPACT_TYPE: ClassVar[Optional[str]] = "Agent"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class Annotation(Element):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/Annotation"
    COMPACT_TYPE: ClassVar[Optional[str]] = "Annotation"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class Artifact(Element):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/Artifact"
    COMPACT_TYPE: ClassVar[Optional[str]] = "Artifact"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
    IS_ABSTRACT: ClassVar[bool]
    ...
    @property
    def originatedBy(self) -> ListProxy[Union[str, 'Agent']]: ...
    @originatedBy.setter
    def originatedBy(self, value: Iterable[Union[str, 'Agent']]) -> None: ...
    releaseTime: Optional[datetime]
    @property
    def standardName(self) -> ListProxy[str]: ...
    @standardName.setter
    def standardName(self, value: Iterable[str]) -> None: ...
    suppliedBy: Optional[Union[str, 'Agent']]
    @property
    def supportLevel(self) -> ListProxy[str]: ...
    @supportLevel.setter
    def supportLevel(self, value: Iterable[str]) -> None: ...
...
class Bundle(ElementCollection):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/Bundle"
    COMPACT_TYPE: ClassVar[Optional[str]] = "Bundle"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class Hash(IntegrityMethod):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/Hash"
    COMPACT_TYPE: ClassVar[Optional[str]] = "Hash"
    NODE_KIND: ClassVar[NodeKind]
...
class LifecycleScopedRelationship(Relationship):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/LifecycleScopedRelationship"
    COMPACT_TYPE: ClassVar[Optional[str]] = "LifecycleScopedRelationship"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class Organization(Agent):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/Organization"
    COMPACT_TYPE: ClassVar[Optional[str]] = "Organization"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class Person(Agent):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/Person"
    COMPACT_TYPE: ClassVar[Optional[str]] = "Person"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class SoftwareAgent(Agent):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/SoftwareAgent"
    COMPACT_TYPE: ClassVar[Optional[str]] = "SoftwareAgent"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class expandedlicensing_ConjunctiveLicenseSet(simplelicensing_AnyLicenseInfo):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/ExpandedLicensing/ConjunctiveLicenseSet"
    COMPACT_TYPE: ClassVar[Optional[str]] = "expandedlicensing_ConjunctiveLicenseSet"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
    ...
    spdxId: Optional[str]
    @property
    def expandedlicensing_member(self) -> ListProxy[Union[str, 'simplelicensing_AnyLicenseInfo']]: ...
    @expandedlicensing_member.setter
    def expandedlicensing_member(self, value: Iterable[Union[str, 'simplelicensing_AnyLicenseInfo']]) -> None: ...
...
class expandedlicensing_CustomLicenseAddition(expandedlicensing_LicenseAddition):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/ExpandedLicensing/CustomLicenseAddition"
    COMPACT_TYPE: ClassVar[Optional[str]] = "expandedlicensing_CustomLicenseAddition"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class expandedlicensing_DisjunctiveLicenseSet(simplelicensing_AnyLicenseInfo):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/ExpandedLicensing/DisjunctiveLicenseSet"
    COMPACT_TYPE: ClassVar[Optional[str]] = "expandedlicensing_DisjunctiveLicenseSet"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class expandedlicensing_ExtendableLicense(simplelicensing_AnyLicenseInfo):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/ExpandedLicensing/ExtendableLicense"
    COMPACT_TYPE: ClassVar[Optional[str]] = "expandedlicensing_ExtendableLicense"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
    IS_ABSTRACT: ClassVar[bool]
...
class expandedlicensing_IndividualLicensingInfo(simplelicensing_AnyLicenseInfo):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/ExpandedLicensing/IndividualLicensingInfo"
    COMPACT_TYPE: ClassVar[Optional[str]] = "expandedlicensing_IndividualLicensingInfo"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
    NAMED_INDIVIDUALS: ClassVar[Dict[str, str]]
...
class expandedlicensing_License(expandedlicensing_ExtendableLicense):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/ExpandedLicensing/License"
    COMPACT_TYPE: ClassVar[Optional[str]] = "expandedlicensing_License"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
    IS_ABSTRACT: ClassVar[bool]
...
class expandedlicensing_ListedLicense(expandedlicensing_License):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/ExpandedLicensing/ListedLicense"
    COMPACT_TYPE: ClassVar[Optional[str]] = "expandedlicensing_ListedLicense"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class expandedlicensing_OrLaterOperator(expandedlicensing_ExtendableLicense):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/ExpandedLicensing/OrLaterOperator"
    COMPACT_TYPE: ClassVar[Optional[str]] = "expandedlicensing_OrLaterOperator"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class expandedlicensing_WithAdditionOperator(simplelicensing_AnyLicenseInfo):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/ExpandedLicensing/WithAdditionOperator"
    COMPACT_TYPE: ClassVar[Optional[str]] = "expandedlicensing_WithAdditionOperator"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class extension_CdxPropertiesExtension(extension_Extension):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Extension/CdxPropertiesExtension"
    COMPACT_TYPE: ClassVar[Optional[str]] = "extension_CdxPropertiesExtension"
    NODE_KIND: ClassVar[NodeKind]
    ...
    @property
    def extension_cdxProperty(self) -> ListProxy[Union[str, 'extension_CdxPropertyEntry']]: ...
    @extension_cdxProperty.setter
    def extension_cdxProperty(self, value: Iterable[Union[str, 'extension_CdxPropertyEntry']]) -> None: ...
...
class security_CvssV2VulnAssessmentRelationship(security_VulnAssessmentRelationship):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Security/CvssV2VulnAssessmentRelationship"
    COMPACT_TYPE: ClassVar[Optional[str]] = "security_CvssV2VulnAssessmentRelationship"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class security_CvssV3VulnAssessmentRelationship(security_VulnAssessmentRelationship):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Security/CvssV3VulnAssessmentRelationship"
    COMPACT_TYPE: ClassVar[Optional[str]] = "security_CvssV3VulnAssessmentRelationship"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class security_CvssV4VulnAssessmentRelationship(security_VulnAssessmentRelationship):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Security/CvssV4VulnAssessmentRelationship"
    COMPACT_TYPE: ClassVar[Optional[str]] = "security_CvssV4VulnAssessmentRelationship"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class security_EpssVulnAssessmentRelationship(security_VulnAssessmentRelationship):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Security/EpssVulnAssessmentRelationship"
    COMPACT_TYPE: ClassVar[Optional[str]] = "security_EpssVulnAssessmentRelationship"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class security_ExploitCatalogVulnAssessmentRelationship(security_VulnAssessmentRelationship):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Security/ExploitCatalogVulnAssessmentRelationship"
    COMPACT_TYPE: ClassVar[Optional[str]] = "security_ExploitCatalogVulnAssessmentRelationship"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class security_SsvcVulnAssessmentRelationship(security_VulnAssessmentRelationship):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Security/SsvcVulnAssessmentRelationship"
    COMPACT_TYPE: ClassVar[Optional[str]] = "security_SsvcVulnAssessmentRelationship"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class security_VexVulnAssessmentRelationship(security_VulnAssessmentRelationship):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Security/VexVulnAssessmentRelationship"
    COMPACT_TYPE: ClassVar[Optional[str]] = "security_VexVulnAssessmentRelationship"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
    IS_ABSTRACT: ClassVar[bool]
...
class security_Vulnerability(Artifact):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Security/Vulnerability"
    COMPACT_TYPE: ClassVar[Optional[str]] = "security_Vulnerability"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class software_SoftwareArtifact(Artifact):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Software/SoftwareArtifact"
    COMPACT_TYPE: ClassVar[Optional[str]] = "software_SoftwareArtifact"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
    IS_ABSTRACT: ClassVar[bool]
    ...
    spdxId: Optional[str]
    @property
    def software_additionalPurpose(self) -> ListProxy[str]: ...
    @software_additionalPurpose.setter
    def software_additionalPurpose(self, value: Iterable[str]) -> None: ...
    @property
    def software_attributionText(self) -> ListProxy[str]: ...
    @software_attributionText.setter
    def software_attributionText(self, value: Iterable[str]) -> None: ...
    @property
    def software_contentIdentifier(self) -> ListProxy[Union[str, 'software_ContentIdentifier']]: ...
    @software_contentIdentifier.setter
    def software_contentIdentifier(self, value: Iterable[Union[str, 'software_ContentIdentifier']]) -> None: ...
...
class Bom(Bundle):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Core/Bom"
    COMPACT_TYPE: ClassVar[Optional[str]] = "Bom"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class expandedlicensing_CustomLicense(expandedlicensing_License):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/ExpandedLicensing/CustomLicense"
    COMPACT_TYPE: ClassVar[Optional[str]] = "expandedlicensing_CustomLicense"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class security_VexAffectedVulnAssessmentRelationship(security_VexVulnAssessmentRelationship):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Security/VexAffectedVulnAssessmentRelationship"
    COMPACT_TYPE: ClassVar[Optional[str]] = "security_VexAffectedVulnAssessmentRelationship"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class security_VexFixedVulnAssessmentRelationship(security_VexVulnAssessmentRelationship):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Security/VexFixedVulnAssessmentRelationship"
    COMPACT_TYPE: ClassVar[Optional[str]] = "security_VexFixedVulnAssessmentRelationship"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class security_VexNotAffectedVulnAssessmentRelationship(security_VexVulnAssessmentRelationship):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Security/VexNotAffectedVulnAssessmentRelationship"
    COMPACT_TYPE: ClassVar[Optional[str]] = "security_VexNotAffectedVulnAssessmentRelationship"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class security_VexUnderInvestigationVulnAssessmentRelationship(security_VexVulnAssessmentRelationship):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Security/VexUnderInvestigationVulnAssessmentRelationship"
    COMPACT_TYPE: ClassVar[Optional[str]] = "security_VexUnderInvestigationVulnAssessmentRelationship"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class software_File(software_SoftwareArtifact):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Software/File"
    COMPACT_TYPE: ClassVar[Optional[str]] = "software_File"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class software_Package(software_SoftwareArtifact):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Software/Package"
    COMPACT_TYPE: ClassVar[Optional[str]] = "software_Package"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class software_Sbom(Bom):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Software/Sbom"
    COMPACT_TYPE: ClassVar[Optional[str]] = "software_Sbom"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
    ...
    spdxId: Optional[str]
    @property
    def software_sbomType(self) -> ListProxy[str]: ...
    @software_sbomType.setter
    def software_sbomType(self, value: Iterable[str]) -> None: ...
...
class software_Snippet(software_SoftwareArtifact):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Software/Snippet"
    COMPACT_TYPE: ClassVar[Optional[str]] = "software_Snippet"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
...
class ai_AIPackage(software_Package):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/AI/AIPackage"
    COMPACT_TYPE: ClassVar[Optional[str]] = "ai_AIPackage"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
    ...
    @property
    def ai_domain(self) -> ListProxy[str]: ...
    @ai_domain.setter
    def ai_domain(self, value: Iterable[str]) -> None: ...
    ai_energyConsumption: Optional[Union[str, 'ai_EnergyConsumption']]
    @property
    def ai_hyperparameter(self) -> ListProxy[Union[str, 'DictionaryEntry']]: ...
    @ai_hyperparameter.setter
    def ai_hyperparameter(self, value: Iterable[Union[str, 'DictionaryEntry']]) -> None: ...
    ai_informationAboutApplication: Optional[str]
    ai_informationAboutTraining: Optional[str]
    ai_limitation: Optional[str]
    @property
    def ai_metric(self) -> ListProxy[Union[str, 'DictionaryEntry']]: ...
    @ai_metric.setter
    def ai_metric(self, value: Iterable[Union[str, 'DictionaryEntry']]) -> None: ...
    @property
    def ai_metricDecisionThreshold(self) -> ListProxy[Union[str, 'DictionaryEntry']]: ...
    @ai_metricDecisionThreshold.setter
    def ai_metricDecisionThreshold(self, value: Iterable[Union[str, 'DictionaryEntry']]) -> None: ...
    @property
    def ai_modelDataPreprocessing(self) -> ListProxy[str]: ...
    @ai_modelDataPreprocessing.setter
    def ai_modelDataPreprocessing(self, value: Iterable[str]) -> None: ...
    @property
    def ai_modelExplainability(self) -> ListProxy[str]: ...
    @ai_modelExplainability.setter
    def ai_modelExplainability(self, value: Iterable[str]) -> None: ...
    ai_safetyRiskAssessment: Optional[str]
    @property
    def ai_standardCompliance(self) -> ListProxy[str]: ...
    @ai_standardCompliance.setter
    def ai_standardCompliance(self, value: Iterable[str]) -> None: ...
    @property
    def ai_typeOfModel(self) -> ListProxy[str]: ...
    @ai_typeOfModel.setter
    def ai_typeOfModel(self, value: Iterable[str]) -> None: ...
...
class dataset_DatasetPackage(software_Package):
    ...
    TYPE: ClassVar[str] = "https://spdx.org/rdf/3.0.1/terms/Dataset/DatasetPackage"
    COMPACT_TYPE: ClassVar[Optional[str]] = "dataset_DatasetPackage"
    NODE_KIND: ClassVar[NodeKind]
    ID_ALIAS: ClassVar[Optional[str]]
    ...
    spdxId: Optional[str]
    @property
    def dataset_anonymizationMethodUsed(self) -> ListProxy[str]: ...
    @dataset_anonymizationMethodUsed.setter
    def dataset_anonymizationMethodUsed(self, value: Iterable[str]) -> None: ...
    dataset_confidentialityLevel: Optional[str]
    dataset_dataCollectionProcess: Optional[str]
    @property
    def dataset_dataPreprocessing(self) -> ListProxy[str]: ...
    @dataset_dataPreprocessing.setter
    def dataset_dataPreprocessing(self, value: Iterable[str]) -> None: ...
    dataset_datasetAvailability: Optional[str]
    dataset_datasetNoise: Optional[str]
    dataset_datasetSize: Optional[int]
    @property
    def dataset_datasetType(self) -> ListProxy[str]: ...
    @dataset_datasetType.setter
    def dataset_datasetType(self, value: Iterable[str]) -> None: ...
    ...
    @property
    def dataset_knownBias(self) -> ListProxy[str]: ...
    @dataset_knownBias.setter
    def dataset_knownBias(self, value: Iterable[str]) -> None: ...
    @property
    def dataset_sensor(self) -> ListProxy[Union[str, 'DictionaryEntry']]: ...
    @dataset_sensor.setter
    def dataset_sensor(self, value: Iterable[Union[str, 'DictionaryEntry']]) -> None: ...
