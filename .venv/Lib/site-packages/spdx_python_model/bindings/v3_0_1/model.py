...
class SHACLObjectMeta(type):
    ...
    def __new__(cls, name, bases, attrs):
        def check_base_prop(name: str) -> bool:
        ...
        iri_properties = {}
        compact_properties = {}
        props: List[ClassProp] = attrs.get("PROPERTIES", [])
        for p in props:
            if not is_base:
                for b in bases:
...
class SHACLObject(metaclass=SHACLObjectMeta):
    ...
    # instead
    COMPACT_TYPE: ClassVar[Optional[str]] = None
    ...
    # Internal variables
    _EXTRA_SLOTS: ClassVar[Union[Set[str], Tuple[str, ...]]] = (
        "_extensible",
        "_metadata",
        "_birth_index",
    )
    _OBJ_PY_PROPS: ClassVar[Dict[str, ClassProp]] = {}
    _OBJ_IRI_PROPS: ClassVar[Dict[str, ClassProp]] = {}
    _OBJ_COMPACT_PROPS: ClassVar[Dict[str, ClassProp]] = {}
    _NEEDS_REG: ClassVar[bool] = True
    _next_birth_index: ClassVar[int] = 0
    _TYPE: ClassVar[str]
    _COMPACT_TYPE: ClassVar[Optional[str]]
    ...
    def set_id(self, value: Optional[str]) -> None:
        """Set the IRI or blank node ID of this object,
        or clear it if value is None."""
        if value is None:
            del self._id
        else:
            self._id = value
    ...
    def __del(self, p: ClassProp) -> None:
        object.__setattr__(self, p.pyname, p.prop.init())
...
class SHACLObjectSet(object):
    ...
    def remove(self, obj: SHACLObject) -> None:
        ...
        NOTE: If the object is still referenced by another object in
        the object set, it will remain indexed
        """
        if not isinstance(obj, SHACLObject):
            raise TypeError("Object is not of type SHACLObject")
...
try:
    ...
    if TYPE_CHECKING:
        from rdflib import Graph  # noqa: I300
...
class Element(SHACLObject):
    ...
    NODE_KIND: ClassVar[NodeKind] = NodeKind.IRI
    ID_ALIAS: ClassVar[Optional[str]] = "spdxId"
    IS_ABSTRACT: ClassVar[bool] = True
    PROPERTIES: ClassVar[List[ClassProp]] = [
        # Provide consumers with comments by the creator of the Element about the
        # Element.
